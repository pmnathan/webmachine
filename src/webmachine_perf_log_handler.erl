...
refresh() ->
    webmachine_log:refresh(os:timestamp()).
...
%% @private
init([BaseDir]) ->
    webmachine_log:defer_refresh(),
    FileName = webmachine_log:log_path(BaseDir, ?FILENAME),
    DateHour = webmachine_log:datehour(),
    filelib:ensure_dir(FileName),
    Handle = webmachine_log:log_open(FileName, DateHour),
